function uselessWebButton(button) {
  ...
  var randomRange = 6;
  let sitelistName = "sitelist-aug-29";
...
var buttonElement = document.querySelector('.feeling-lucky-button');
var uselessWebButtonInstance = new uselessWebButton(buttonElement);
